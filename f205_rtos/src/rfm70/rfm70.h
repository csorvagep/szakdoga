...
void rfm70_buffer_read(unsigned char reg, unsigned char *buf,
...
void rfm70_buffer_write(char reg, const unsigned char *buf,
		unsigned char length);
...
//! 
//! The RFM70 must be in transmit mode.
unsigned char rfm70_receive(unsigned char * pipe, unsigned char *buf,
		unsigned char * length);
